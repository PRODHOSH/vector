...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex w-full bg-white font-sans text-black overflow-hidden">
      <motion.div 
        layout
        className={`flex w-full min-h-screen ${activeTab === "signin" && !isResetMode ? "flex-col lg:flex-row" : "flex-col lg:flex-row-reverse"}`}
...
function AuthForms({ 
  ...
  isResetMode: boolean, 
  setIsResetMode: (v: boolean) => void, 
  activeTab: "signin" | "signup", 
  setActiveTab: (v: "signin" | "signup") => void 
}) {
