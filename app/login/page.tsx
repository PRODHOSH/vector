    ...
    <div className="flex min-h-screen items-center justify-center bg-zinc-50 p-4 dark:bg-black">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-4 flex flex-col items-center text-center">
          <Logo width={48} height={48} className="h-12 w-12 object-contain" />
          <div className="space-y-1">
            <CardTitle className="text-2xl font-bold">Welcome to Vector</CardTitle>
          <CardDescription>
            Login to your student task management account
          </CardDescription>
          </div>
        </CardHeader>
