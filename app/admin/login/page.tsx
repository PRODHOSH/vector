...
export default function AdminLoginPage() {
  return (
    <div className="min-h-screen flex w-full bg-white font-sans text-black overflow-hidden">
      <motion.div 
        layout
        className="flex w-full min-h-screen flex-col lg:flex-row"
          ...
          <div className="relative z-10">
            ...
            <div className="mt-20">
              ...
              <p className="text-lg text-black/70 max-w-md leading-relaxed font-medium drop-shadow-sm">
                Log in to the Admin Dashboard to manage users, configure settings, and oversee the platform.
              </p>
            </div>
          </div>
          ...
          <div className="mx-auto w-full max-w-sm">
            ...
            <div className="mb-8">
              ...
              <p className="text-zinc-500 text-sm">
                Please continue with your Google Administrator account.
              </p>
            </div>
  ...
  return (
    <>
      <div className="grid grid-cols-1 gap-3 mt-6">
        <Button variant="outline" onClick={() => handleOAuthLogin("google")} className="h-12 rounded-xl bg-white text-black border-zinc-200 hover:bg-zinc-100 dark:bg-white dark:text-black dark:border-zinc-200 dark:hover:bg-zinc-100 font-semibold transition-all">
